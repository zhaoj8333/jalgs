 ...
 *    冒泡排序在处理大量数据时应该避免使用
 *
 *  The only advantage of bubble phase1.algs.sort is the ability to detect whether the array is sorted
 *
 * 3. The distance and direction that elements must move during the phase1.algs.sort determine bubble phase1.algs.sort's performance because elements move in different directions at different speeds
 ...
 *
 * 6. Improvement:
 *    CockTail phase1.algs.sort: bi-direction bubble phase1.algs.sort
 *    Comb phase1.algs.sort    : compares elements separated by large gaps, and can move turtles extremely quickly
 *
 * 7. Bubble Sort also interacts poorly with modern CPU hardware.
 *    It produces at least twice as many writes as insertion phase1.algs.sort, twice as many cache misses, and asymptotically more branch mispredictions
...
//    public static void phase1.algs.sort(Comparable[] arr) {
//        sortOptimize(arr);
//    }

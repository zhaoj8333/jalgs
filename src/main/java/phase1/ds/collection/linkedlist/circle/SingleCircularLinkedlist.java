package phase1.ds.collection.linkedlist.circle;
...
//                first = null;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("size: " + scll.size);
        scll.remove(3);
        System.out.println(scll);
        scll.remove(6);
        System.out.println(scll);
...
//        System.out.println(scll);
        ...
        il.add(8);
        il.add(10);
//        System.out.println(maxByWhile(il.first));
//        max = il.first.data;
//        System.out.println(maxByRecursion(il.first, il.first));
        il.remove(4);
//        il.remove(3);
//        il.remove(2);
//        il.remove(1);

 ...
 * quickunion基于size的优化
 */
public class UnionFindQURankPathSplitting extends UnionFindQU {
    private int[] ranks;
     ...
     *  路径减半:
     */
    public UnionFindQURankPathSplitting(int capacity) {
        super(capacity);
     ...
     */
     ...
     public static void main(String[] args) {
         UnionFindQURankPathSplitting uf = new UnionFindQURankPathSplitting(10);
         uf.union(0, 1);
         uf.union(0, 3);
         uf.union(0, 4);

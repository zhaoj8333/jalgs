...
//    public static void
    ...
    private static BinaryTree3<Integer> findComplateBinaryTree() {
        while (true) {
            ...
            for (int i = 0; i < 40; i++) {
                Integer tmp = new Random().nextInt(20);
                bt3.add(tmp);
                arr[i] = tmp;
            }
...
//                break;
    ...
    public static void main(String[] args) {
        ...
        BinaryTree3<Integer> bt3 = new BinaryTree3<>();
        random = new Random().nextInt(num);
        for (int i = 0; i < num; i++) {
            Integer tmp = new Random().nextInt(num);
//            tmp = arr[i];
//            arr[i] = tmp;
            bt3.add(tmp);
        }
//        System.out.println(Arrays.toString(arr));
//        System.out.println("是否为完全树: " + bt3.isComplete());
//        bt3.traversal(4);
//        traverse(bt3);
...
//        bt3.testGet(bt3);
    ...
    public void testGet(BinaryTree3<Integer> bt3) {
        ...
        if (node != null) {
            ...
            System.out.println("predecessor: " + bt3.predecessor(node).element);
            System.out.println("succcessor:  " + bt3.successor(node).element);
        }
    }
...
//        BinaryTrees.println(bt3);
        if (tmp != null) {
            System.out.println("tmp节点： " + tmp.element.toString());
            BinaryTree3.Node<Integer> predecessor = bt3.predecessor(bt3.tmp);
            System.out.println("前序节点： " + (predecessor == null ? "null" : predecessor.element.toString()));
            BinaryTree3.Node<Integer> successor = bt3.successor(bt3.tmp);
            System.out.println("后续节点： " + (successor == null ? "null" : successor.element.toString()));
        }
    }
}

...
//        putHashMap();
    ...
    private static void and(Object o) {
        ...
        System.out.println("phase1.algs.hash: " + Integer.toBinaryString(hash));
        System.out.println("phase1.algs.hash: " + hash);
...
//      因为位运算相对于取余操作很费时
        /*
            ...
            phase1.algs.hash:  00000000 00000000 00000000 01100001
            &:
                   00000000 00000000 00000000 00000001
         */
        /*
            i - 1: 00000000 00000000 00000000 00001111
            phase1.algs.hash:  00111101 00000011 00010010 11111001
            &:     00000000 00000000 00000000 00001001  9
         */

        /*
            为何hashmap长度总是2的n次幂，因为hash & (table.length - 1)来得到该对象
            的保存位。 phase1.algs.hash & (table.length - 1)运算等价于对length取模，也即是 phase1.algs.hash % length
         */
    }
...
//        System.out.println("n: " + Integer.toBinaryString(n));
    ...
    private static void defaultCapacityNpowerof2() {
        ...
        //      该算法实际上就是取模,phase1.algs.hash % length,计算机中直接求余不如位运算效率高，所以源码中做了优化
        //      phase1.algs.hash&(length - 1)，而实际上hash % length等于hash&(length - 1)前提是length = 2的n次幂
        //
        // 为何该方法可以减少hash碰撞????
        // 按位与
        // phase1.algs.hash & (length - 1)如何减少hash碰撞??
        System.out.println((3 & (8 - 1)));
        /**
         * phase1.algs.hash: 3 长度 8
         * 0000 0011  3
         * 0000 0111  7
         *----------------
         * 0000 0011  3
         ...
         * 所以2的n次幂,是为了减少hash碰撞, 且使用位运算提高put效率
         * 链表或红黑树过长，效率降低
         */
    }
...
//        defaultCapacityNpowerof2();
        ...
        //    理想情况下hashCode算法下所有bin中节点分布频率会遵循 泊松分布,一个bin中

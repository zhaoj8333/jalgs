...
public class HeapSort2<T> extends Sort<T> implements BinaryTreeInfo {
    ...
    public void sort() {
        heapify();
        System.out.println("heapify: " + Arrays.toString(heap));
    ...
    public static void main(String[] args) {
        ...
        System.out.println("before:  " + Arrays.toString(hs.getHeap()));
        hs.sort();
        System.out.println("after :  " + Arrays.toString(hs.getHeap()));

...
//        testMap();
    ...
    private static void testMap() {
        ...
        mp.remove("b");
//        StdOut.println("size : " + mp.size());
//        StdOut.println("map  : " + mp);
//        StdOut.println("containsKey: ");
//        StdOut.println(mp.containsKey("b"));
//        StdOut.println(mp.containsKey("a"));
//        StdOut.println(mp.containsKey(null));

//        StdOut.println("containsValue: ");
//        StdOut.println(mp.containsValue(3));
//        StdOut.println(mp.containsValue(10));

        mp.traversal(null);
        //        StdOut.println(mp.get("a"));
//        StdOut.println(mp.get("b"));
//        StdOut.println(mp.get("c"));
//        StdOut.println(mp.get(null));
        StdOut.println("=======================================");
        StdOut.println("table: " + Arrays.toString(mp.table));
        mp.print();
    }
}

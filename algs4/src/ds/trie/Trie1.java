...
//        StdOut.println("c   : " + trie.contains("c"));
//        StdOut.println("ca  : " + trie.contains("ca"));
//        StdOut.println("cat : " + trie.contains("cat"));
//        StdOut.println("cata: " + trie.contains("cata"));
//        StdOut.println("阿斯 : " + trie.contains("阿斯"));
        StdOut.println("c   : " + trie.startsWith("c"));
        StdOut.println("ca  : " + trie.startsWith("ca"));
        StdOut.println("cat : " + trie.startsWith("cat"));
        StdOut.println("cata: " + trie.startsWith("cata"));
        StdOut.println("阿斯 : " + trie.startsWith("阿斯"));

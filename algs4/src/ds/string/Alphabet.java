...
//        StdOut.println(Arrays.toString(unicode));
//        StdOut.println(Character.MAX_VALUE);
//        System.exit(0);
...
//        StdOut.println(Arrays.toString(alphabet));
        R = alpha.length();
        inverse = new int[Character.MAX_VALUE];
        for (int i = 0; i < inverse.length; i++) {
            inverse[i] = -1;
        }
//        StdOut.println(Arrays.toString(inverse));
        for (int c = 0; c < R; c++) {
            inverse[alphabet[c]] = c;
//            StdOut.println(alphabet[c]);
        }
//        StdOut.println(Arrays.toString(inverse));
    }
